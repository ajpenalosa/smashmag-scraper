...
var MONGODB_URI = process.env.MONGODB_URI || "mongodb://localhost/smashingmagazine";
...
app.get("/scrape", function(req, res) {
  ...
  axios.get("https://www.smashingmagazine.com/").then(function(response) {
    ...
    $(".article--grid__content-wrapper").each(function(i, element) {
      ...
      // Add the text, body and href of every link, and save them as properties of the result object
      result.title = $(this)
        .children("header")
        .children("h2")
        .children("a")
